...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/hubdog/Projects/android-ndk-r9/sources/FFmpeg/android/arm --enable-shared --disable-static --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --enable-avdevice --disable-encoders --disable-muxers --disable-doc --disable-symver --disable-indev=dv1394 --disable-indev=v4l2 --disable-indev=fbdev --disable-protocol=libssh --disable-outdevs --disable-decoder=h264_vdpau --cross-prefix=/home/hubdog/Projects/android-ndk-r9/toolchains/arm-linux-androideabi-4.8/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --target-os=linux --pkg-config=pkg-config --arch=arm --cpu=armv7-a --enable-cross-compile --sysroot=/home/hubdog/Projects/android-ndk-r9/platforms/android-9/arch-arm/ --extra-cflags='-Os -fpic  -march=armv7-a -mfloat-abi=softfp -mfpu=neon' --extra-ldflags= --extra-cxxflags=
prefix=/home/hubdog/Projects/android-ndk-r9/sources/FFmpeg/android/arm
...
LD_PATH=-L
DLLTOOL=
LDFLAGS=   --sysroot=/home/hubdog/Projects/android-ndk-r9/platforms/android-9/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
