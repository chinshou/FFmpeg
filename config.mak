...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=../android/arm --enable-shared --disable-static --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --enable-avdevice --enable-nonfree --enable-libx264 --enable-libvpx --enable-libfaac --enable-libvorbis --enable-libfreetype --enable-openssl --enable-libgsm --enable-libmp3lame --enable-libsox --enable-librtmp --enable-libvidstab --disable-decoder=libvpx --enable-gpl --disable-doc --disable-symver --disable-indev=dv1394 --disable-indev=v4l2 --disable-indev=fbdev --disable-protocol=libssh --disable-outdevs --disable-postproc --disable-decoder=h264_vdpau --cross-prefix=/home/hubdog/Projects/android-ndk-r9/toolchains/arm-linux-androideabi-4.8/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --target-os=linux --pkg-config=pkg-config --arch=arm --cpu=armv7-a --enable-cross-compile --sysroot=/home/hubdog/Projects/android-ndk-r9/platforms/android-9/arch-arm/ --extra-cflags='-Os -fpic  -I../android/arm/include  -march=armv7-a -mfloat-abi=softfp -mfpu=neon' --extra-ldflags=' -L../android/arm/lib ' --extra-cxxflags=
prefix=../android/arm
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -L../android/arm/lib  --sysroot=/home/hubdog/Projects/android-ndk-r9/platforms/android-9/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS=-lssl -lcrypto -lx264 -lvpx -lvpx -lvorbisenc -lvorbis -logg -L/home/hubdog/Projects/android-ndk-r9/sources/android/arm/lib -lvidstab -lsox -L/home/hubdog/Projects/android-ndk-r9/sources/android/arm/lib -lrtmp -lz -lssl -lcrypto -lmp3lame -lgsm -L/home/hubdog/Projects/android-ndk-r9/sources/android/arm/lib -lfreetype -lfaac -lm -lz 
