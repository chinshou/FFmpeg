...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/home/hubdog/Projects/android-ndk-r9/platforms/android-9/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC
CFLAGS=  -Os -fpic -I../android/arm/include -march=armv7-a -mfloat-abi=softfp -mfpu=neon -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -I/home/hubdog/Projects/android-ndk-r9/sources/android/arm/include/freetype2 -I/home/hubdog/Projects/android-ndk-r9/sources/android/arm/include -I/home/hubdog/Projects/android-ndk-r9/sources/android/arm/include -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wno-maybe-uninitialized
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -fuse-ld=bfd -L../android/arm/lib  --sysroot=/home/hubdog/Projects/android-ndk-r9/platforms/android-9/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS=-lssl -lcrypto -lx264 -lvorbisenc -lvorbis -logg -L/home/hubdog/Projects/android-ndk-r9/sources/android/arm/lib -lvidstab -lsox -L/home/hubdog/Projects/android-ndk-r9/sources/android/arm/lib -lrtmp -lz -lssl -lcrypto -lmp3lame -lgsm -L/home/hubdog/Projects/android-ndk-r9/sources/android/arm/lib -lfreetype -lfaac -lm -lz 
