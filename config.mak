...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=../android/arm --enable-shared --disable-static --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --enable-avdevice --enable-nonfree --enable-libx264 --enable-libfaac --enable-libvorbis --enable-libfreetype --enable-openssl --enable-libgsm --enable-libmp3lame --enable-libsox --enable-librtmp --enable-libvidstab --disable-decoder=libvpx --enable-gpl --disable-doc --disable-symver --disable-indev=dv1394 --disable-indev=v4l2 --disable-indev=fbdev --disable-protocol=libssh --disable-outdevs --disable-postproc --disable-decoder=h264_vdpau --disable-indev=waveform --cross-prefix=/home/hubdog/Projects/android-ndk-r9/toolchains/arm-linux-androideabi-4.8/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --target-os=linux --pkg-config=pkg-config --arch=arm --cpu=armv7-a --enable-cross-compile --sysroot=/home/hubdog/Projects/android-ndk-r9/platforms/android-9/arch-arm/ --extra-cflags='-Os -fpic  -I../android/arm/include  -march=armv7-a -mfloat-abi=softfp -mfpu=neon' --extra-ldflags=' -fuse-ld=bfd -L../android/arm/lib ' --extra-cxxflags=
prefix=../android/arm
...
ARFLAGS=rc
AR_O=$@
RANLIB=/home/hubdog/Projects/android-ndk-r9/toolchains/arm-linux-androideabi-4.8/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ranlib
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/home/hubdog/Projects/android-ndk-r9/platforms/android-9/arch-arm/ -isysroot /home/hubdog/Projects/android-ndk-r9/platforms/android-9/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC
CFLAGS=  -Os -fpic -I../android/arm/include -march=armv7-a -mfloat-abi=softfp -mfpu=neon -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -I/home/hubdog/Projects/android-ndk-r9/sources/android/arm/include/freetype2 -I/home/hubdog/Projects/android-ndk-r9/sources/android/arm/include -I/home/hubdog/Projects/android-ndk-r9/sources/android/arm/include -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wno-maybe-uninitialized
...
LDFLAGS= -fuse-ld=bfd -L../android/arm/lib  --sysroot=/home/hubdog/Projects/android-ndk-r9/platforms/android-9/arch-arm/ -isysroot /home/hubdog/Projects/android-ndk-r9/platforms/android-9/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS=-lssl -lcrypto -lx264 -lvorbisenc -lvorbis -logg -L/home/hubdog/Projects/android-ndk-r9/sources/android/arm/lib -lvidstab -lsox -L/home/hubdog/Projects/android-ndk-r9/sources/android/arm/lib -lrtmp -lz -lssl -lcrypto -lmp3lame -lgsm -L/home/hubdog/Projects/android-ndk-r9/sources/android/arm/lib -lfreetype -lfaac -lm -lz -pthread 
