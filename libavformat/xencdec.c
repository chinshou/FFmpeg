...
static int xenc_read_close(AVFormatContext *s);
 ...
 * Autodetecting...
 */
static int xenc_probe(const AVProbeData *p)
{
    uint64_t total = 0;
...
static int xenc_read_header(AVFormatContext *s)
{
    MatroskaDemuxContext *matroska = s->priv_data;
    ...
    matroska->ctx = s;
    matroska->cues_parsing_deferred = 0;//1;
...
static int xenc_read_packet(AVFormatContext *s, AVPacket *pkt)
{
    MatroskaDemuxContext *matroska = s->priv_data;
    int ret = 0;
...
static int xenc_read_seek(AVFormatContext *s, int stream_index,
...
AVInputFormat ff_encx_demuxer = {
    ...
    .read_packet    = xenc_read_packet,
    .read_close     = xenc_read_close,
    .read_seek      = xenc_read_seek,
