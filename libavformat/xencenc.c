...
static int xev_write_header(AVFormatContext *s)
{
    MatroskaMuxContext *mkv = s->priv_data;
    AVIOContext *pb = s->pb;
...
static int xev_write_flush_packet(AVFormatContext *s, AVPacket *pkt)
{
    MatroskaMuxContext *mkv = s->priv_data;
    AVIOContext *pb;
    if (s->pb->seekable)
...
static int xev_write_trailer(AVFormatContext *s)
{
    MatroskaMuxContext *mkv = s->priv_data;
    AVIOContext *pb = s->pb;
...
static int xev_query_codec(enum AVCodecID codec_id, int std_compliance)
{
    int i;
...
AVOutputFormat ff_encx_muxer = {
    ...
    .write_header      = xev_write_header,
    .write_packet      = xev_write_flush_packet,
    .write_trailer     = xev_write_trailer,
