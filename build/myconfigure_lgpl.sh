...
../configure --arch=x86 --target-os=mingw32 --cross-prefix=i686-w64-mingw32-  \
 ...
 --enable-version3  --enable-avfilter \
 --enable-runtime-cpudetect --pkg-config=pkg-config \
 ...
 --enable-libass --enable-libbluray --enable-decklink \
 --enable-openssl --enable-libopus  \
 --enable-libvo-amrwbenc  --enable-libwebp  --enable-nvenc --enable-cuda --enable-cuvid \
 --disable-demuxer=encx --enable-libsrt --enable-libmfx  \
 --disable-muxer=encx \
 ...
 --disable-outdev=sdl --extra-cflags="-I/usr/i686-mingw32/include -I/home/hubdog/Projects/ffmpeg-win/BlackmagicDeckLinkSDK11.0/Win/include"  \
