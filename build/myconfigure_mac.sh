...
--enable-libfreetype --enable-version3 --enable-libvo-aacenc --enable-libtheora --enable-libspeex  \
...
--enable-libbluray --enable-libflite  --enable-libcelt --enable-libxvid --enable-libopenjpeg  --enable-libilbc --enable-libass --enable-libquvi
