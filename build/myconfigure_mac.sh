...
LDFLAGS="-arch i386 -L/usr/lib -L/usr/darwin32/lib -static-libstdc++ -static-libgcc " CPPFLAGS="-arch i386 -I/usr/darwin32/include" CFLAGS="-arch i386 -I/usr/darwin32/include" ../configure --enable-memalign-hack --disable-outdev=sdl --arch=x86  \
