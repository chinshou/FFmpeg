...
../configure --arch=x86 --target-os=mingw32 --cross-prefix=x86_64-w64-mingw32-  \
 --cc='x86_64-w64-mingw32-gcc' --enable-shared --disable-static  \
 ...
 --enable-libwebp --enable-libxml2  --enable-libharfbuzz \
 --disable-muxer=encx --enable-libdav1d --enable-w32threads --disable-pthreads \
