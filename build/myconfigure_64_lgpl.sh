...
../configure --arch=x86 --target-os=mingw32 --cross-prefix=x86_64-w64-mingw32-  \
 ...
 --enable-libbluray --enable-libvo-amrwbenc \
 ...
 --disable-outdev=sdl --extra-cflags="-I/usr/x86_64-mingw32/include -I/home/hubdog/Projects/ffmpeg-win/BlackmagicDeckLinkSDK11.0/Win/include"  \
