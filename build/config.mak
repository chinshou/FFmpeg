...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-memalign-hack --arch=x86 --target-os=mingw32 --cross-prefix=i686-w64-mingw32- --cc=i686-w64-mingw32-gcc --disable-postproc --enable-shared --disable-static --disable-decoder=libvpx --enable-avisynth --enable-gpl --enable-version3 --enable-pthreads --enable-avfilter --enable-runtime-cpudetect --enable-nonfree --pkg-config=pkg-config --enable-libfaac --enable-libnut --enable-libgsm --enable-libfreetype --enable-libvorbis --enable-libspeex --enable-libmp3lame --enable-zlib --enable-libtheora --enable-bzlib --enable-libvpx --enable-libxvid --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-libopenjpeg --enable-libschroedinger --enable-librtmp --enable-libass --enable-libx264 --enable-libbluray --enable-openssl --enable-libsox --disable-ffplay --enable-libx265 --enable-libcdio --enable-libcelt --enable-libvo-amrwbenc --enable-libwebp --disable-muxer=encx --disable-muxer=encx_audio --disable-demuxer=encx_audio --disable-demuxer=encx --enable-libmfx --pkg-config-flags=--static --enable-libxavs --disable-outdev=sdl --extra-cflags=-I/usr/i686-mingw32/include --extra-ldflags='-L/usr/i686-mingw32/lib -static -static-libgcc -static-libstdc++ ' --extra-libs='-lx264 -lpthread -lwinmm -llua -liconv -lcurl -lws2_32 -lssl -lcrypto  -lwldap32 -lgdi32 -lwsock32 -lexpat'
prefix=/usr/local
...
INSTALL_NAME_DIR=
SRC_PATH=/home/hubdog/Projects/ffmpeg-win/FFmpeg
SRC_LINK=src
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=gcc 4.9.2 (GCC)
ARCH=x86
INTRINSICS=none
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__ -DZLIB_CONST
CFLAGS=  -I/usr/i686-mingw32/include -std=c99 -fomit-frame-pointer -pthread -I/usr/i686-mingw32/include -I/usr/i686-mingw32/include/freetype2 -I/usr/i686-mingw32/include -I/usr/i686-mingw32/include/fribidi -I/usr/i686-mingw32/include/freetype2 -I/usr/i686-mingw32/include -I/usr/i686-mingw32/include -I/usr/i686-mingw32/include/freetype2 -I/usr/i686-mingw32/include -I/usr/i686-mingw32/include -I/usr/i686-mingw32/include -I/usr/i686-mingw32/include/schroedinger-1.0 -I/usr/i686-mingw32/include/orc-0.4 -I/usr/i686-mingw32/include -I/usr/i686-mingw32/include -I/usr/i686-mingw32/include -I/usr/i686-mingw32/include -I/usr/i686-mingw32/include -I/usr/i686-mingw32//include -I/usr/i686-mingw32/include -D_GNU_SOURCE=1 -Dmain=SDL_main -I/usr/i686-mingw32/include/SDL -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
OBJCFLAGS=  
ASFLAGS=  -I/usr/i686-mingw32/include -g
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -L/usr/i686-mingw32/lib -static -static-libgcc -static-libstdc++  -Wl,--large-address-aware -Wl,--nxcompat,--dynamicbase -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS= -Wl,--pic-executable,-e,_mainCRTStartup
LDLIBFLAGS=
SHFLAGS=-shared -Wl,--output-def,$$(@:$(SLIBSUF)=.orig.def) -Wl,--out-implib,$(SUBDIR)lib$(SLIBNAME:$(SLIBSUF)=.dll.a) -Wl,--enable-runtime-pseudo-reloc -Wl,--disable-auto-image-base -Wl,-Bsymbolic -Wl,--version-script,$(SUBDIR)lib$(NAME).ver
ASMSTRIPFLAGS= -wN '..@*'
...
CFLAGS-ffplay=-D_GNU_SOURCE=1 -Dmain=SDL_main -I/usr/i686-mingw32/include/SDL
ZLIB=-lz
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-lws2_32 -lwinmm -lavicap32 -lgdi32 -lpsapi -lole32 -lstrmiids -luuid -loleaut32 -lshlwapi -lcdio_paranoia -lcdio_cdda -lcdio -L/usr/i686-mingw32/lib -lmingw32 -lSDLmain -lSDL -mwindows -lmingw32 -lSDLmain -lSDL -mwindows -lm -luser32 -lgdi32 -lwinmm -ldxguid -mconsole -L/usr/i686-mingw32/lib -lssl -lcrypto -lws2_32 -lgdi32 -lcrypt32 -lxvidcore -lxavs -L/usr/i686-mingw32//lib -lx265 -lstdc++ -lmingw32 -lmoldname -lmingwex -lmsvcrt -ladvapi32 -lshell32 -luser32 -lkernel32 -lmingw32 -lmoldname -lmingwex -lmsvcrt -L/usr/i686-mingw32/lib -lx264 -lpthread -L/usr/i686-mingw32/lib -lwebp -lm -pthread -L/usr/i686-mingw32/lib -lvpx -L/usr/i686-mingw32/lib -lvpx -lvorbisenc -lvorbis -logg -lvo-amrwbenc -ltheoraenc -ltheoradec -logg -L/usr/i686-mingw32/lib -lspeex -lm -lsox -L/usr/i686-mingw32/lib -lschroedinger-1.0 -lorc-0.4 -lm -lorc-0.4 -lm -L/usr/i686-mingw32/lib -lrtmp -lz -lssl -lcrypto -lws2_32 -lgdi32 -lcrypt32 -lcrypto -lws2_32 -lgdi32 -lcrypt32 -lopenjpeg -DOPJ_STATIC -lopencore-amrwb -lopencore-amrnb -lnut -lmp3lame -L/usr/i686-mingw32/lib -lmfx -lstdc++ -lgsm -L/usr/i686-mingw32/lib -lfreetype -lfaac -lcelt0 -lcelt0 -L/usr/i686-mingw32/lib -lbluray -L/usr/i686-mingw32/lib -lass -lm -lfontconfig -lexpat -lfreetype -lexpat -lfribidi -lfreetype  -lm -lbz2 -lz -pthread -lpsapi -ladvapi32 -lshell32 -lx264 -lpthread -lwinmm -llua -liconv -lcurl -lws2_32 -lssl -lcrypto -lwldap32 -lgdi32 -lwsock32 -lexpat 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=i386
...
LIBS-ffplay=-L/usr/i686-mingw32/lib -lmingw32 -lSDLmain -lSDL -mwindows -lmingw32 -lSDLmain -lSDL -mwindows -lm -luser32 -lgdi32 -lwinmm -ldxguid -mconsole
LIBS-ffprobe=
LIBS-ffserver=
LIBS-ffmpeg=-lole32 -luser32
!ARCH_AARCH64=yes
!ARCH_ALPHA=yes
!ARCH_ARM=yes
!ARCH_AVR32=yes
